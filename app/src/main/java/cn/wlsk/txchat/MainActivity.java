...
import cn.wlsk.txchat.contact.ContactFragment;
import cn.wlsk.txchat.conversation.ConversationFragment;
import cn.wlsk.txchat.profile.ProfileFragment;
import cn.wlsk.txchat.scenes.ScenesFragment;
import cn.wlsk.txchat.thirdpush.HUAWEIHmsMessageService;
import cn.wlsk.txchat.thirdpush.OPPOPushImpl;
import cn.wlsk.txchat.thirdpush.ThirdPushTokenMgr;
import cn.wlsk.txchat.utils.BrandUtil;
import cn.wlsk.txchat.utils.Constants;
import cn.wlsk.txchat.utils.DemoLog;
import cn.wlsk.txchat.utils.PrivateConstants;
...
public class MainActivity extends BaseActivity implements ConversationManagerKit.MessageUnreadWatcher {
    ...
    private void login() {
        String name = "456789";
        TUIKit.login(name, GenerateTestUserSig.genTestUserSig(name), new IUIKitCallBack() {
            @Override
